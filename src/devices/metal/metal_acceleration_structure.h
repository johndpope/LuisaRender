...
#import <core/acceleration_structure.h>
...
public:
    MetalAccelerationStructure(MPSTriangleAccelerationStructure *structure, MPSRayIntersector *nearest_its, MPSRayIntersector *any_its) noexcept
